...
export default function Page() {
  ...
  return (
    ...
    <Canvas shadows onPointerDown={(e) => (e.target as HTMLCanvasElement).requestPointerLock()}>
        ...
        <Environment files="/night.hdr" ground={{ height: 5, radius: 40, scale: 200 }} />
        ...
        <Physics timeStep="vary">
          ...
          <RigidBody type="fixed" colliders="trimesh">
            <Gltf /*castShadow receiveShadow rotation={[-Math.PI / 2, 0, 0]} scale={0.11}*/src="/.dragon_age_inquistion_skyhold_throne_room.glb" />
          </RigidBody>
        </Physics>
